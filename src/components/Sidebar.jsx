...
const Sidebar = () => {
  ...
  const normaleLink ="flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-500 dark:text-gray-300 dark:hover:text-black hover:bg-light-gray m-2"
           ...
           uppercase'>
              ...
              {item.links.map((link) =>(
                <NavLink 
                 ...
                 className={({isActive})=> 
                 isActive ? activeLink : normaleLink
                 }
                >
                 {link.icon }
